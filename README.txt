...
************************
Addendum - Almost half a decade later
************************
I'm working on updating this to work with CodeIgniter 2.0.2. A lot of the functions/libraries used no longer exist. So far I've repaired the create-user function.
-Brandon Probst